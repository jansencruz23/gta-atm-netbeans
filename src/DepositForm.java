...
public class DepositForm extends JFrame {
    ...
    private void initComponents() {
        ...
        txtDeposit.setFont(new java.awt.Font("Pricedown Bl", 0, 36)); // NOI18N
        ...
        lblTitle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/deposit2.png"))); // NOI18N
        getContentPane().add(lblTitle);
        lblTitle.setBounds(0, 30, 850, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/TA3.jpg"))); // NOI18N
